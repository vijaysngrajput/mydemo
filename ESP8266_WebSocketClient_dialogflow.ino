...
const char* ssid     = "vijayRajput"; //enter your ssid/ wi-fi(case sensitiv) router name - 2.4 Ghz only
const char* password = "123456789";     // enter ssid password (case sensitiv)
char host[] = "myfirstespiot.herokuapp.com"; //enter your Heroku domain name like "espiot.herokuapp.com" 
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
